"""Publish the Phase 4A recap to the Obsidian vault and repo docs/recaps/.

Usage: uv run python scripts/publish_4a_recap.py
"""
...
FILENAME = f"{DATE_SLUG}_phase4a_research_parallelization.md"

FRONTMATTER = f"""---
title: "Session Recap: Phase 4A Research Parallelization"
type: code-recap
status: complete
...
tags:
  ...
  - parallelization
aliases:
  - "Recap 2026-04-23 Phase 4A"
---
"""

BODY = """# Session Recap: Phase 4A Research Parallelization
...
# Write to repo docs/recaps/ (no frontmatter)
